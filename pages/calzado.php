...
<form action="datos.php" method="POST">
	...
	<div class="card" style="width: 18rem;">
  		<img src="/tienda/images/tenis.jpg" class="card-img-top" alt="Air jordan" style="width: 17rem">
  		<div class="card-body">
...
<form action="datos.php" method="POST">
  ...
  <div class="card" style="width: 18rem;">
      <img src="/tienda/images/tenisnike.jpg" class="card-img-top" alt="tenisnike">
      <div class="card-body">
...
<form action="datos.php" method="POST">
      <div class="card" style="width: 18rem;">
        <img src="/tienda/images/tacones.jpg" class="card-img-top" alt="tacones">
        <div class="card-body">
