...
<form action="datos.php" method="POST">
    	<div class="card" style="width: 18rem;">
  			<img src="/tienda/images/camisas.jpg" class="card-img-top" alt="camisas">
  			<div class="card-body">
...
<form action="datos.php" method="POST">
    	...
    	<div class="card" style="width: 18rem;">
  			<img src="/tienda/images/camisa.jpg" class="card-img-top" alt="camisa">
  			<div class="card-body">
...
<form action="datos.php" method="POST">
      <div class="card" style="width: 18rem;">
        ...
        <img src="/tienda/images/buz.jpg" class="card-img-top" alt="buzos">
        <div class="card-body">
